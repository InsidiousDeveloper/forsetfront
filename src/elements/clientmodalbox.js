                ...
                <div className="car-info">
                    ...
                    <div className="car-details">
                        <div className="column">
                            <div>{id} ID</div>
                            <h2>{prop.clients.client_id}</h2>
                        </div>
                        <div className="column">
                            <div>{user} Full name</div>
                            <h2>{prop.clients.firstName} {prop.clients.lastName} {prop.clients.secondName}</h2>
                        </div>
                        <div className="column">
                            <div>{phone} phone</div>
                            <h2>{prop.clients.phone}</h2>
                        </div>
                        <div className="column">
                            <div>{passport} Passport</div>
                            <h2>{prop.clients.passport}</h2>
                        </div>
                    </div>
                </div>
                <div className="car-story">
                    <div className="renting">
                        <h2>{carIcon}Currently renting</h2>
