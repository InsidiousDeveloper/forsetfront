            ...
            <div className="modal-content">
                <div className="car-info">
                    <div className="car-img">
                        ...
                        <div className="status">
                            <span className={prop.cars.status}>{prop.cars.status}</span>
                        </div>
                    </div>
                    <div className="car-details">
                        <div className="column">
                            <div>{id} ID</div>
                            <h2>{prop.cars.car_id}</h2>
                        </div>
                        <div className="column">
                            <div>{carIcon} Brand</div>
                            <h2>{prop.cars.brand}</h2>
                        </div>
                        <div className="column">
                            <div>{model} Model</div>
                            <h2>{prop.cars.model}</h2>
                        </div>
                        <div className="column">
                            <div>{numberplate} Number</div>
                            <h2>{prop.cars.car_num}</h2>
                        </div>
                    </div>
                </div>
                <div className="car-description">
                    <div className="car-details">
                        <div className="column">
                            <div>{tire} Tire</div>
                            <h2>{prop.cars.wheels_model}</h2>
                        </div>
                        <div className="column">
                            <div>{accumulator} Accumulator</div>
                            <h2>{prop.cars.battery}</h2>
                        </div>
                        <div className="column">
                            <div>{cost} Price</div>
                            <h2>{prop.cars.cost} сум/месяц</h2>
                        </div>
                        <div className="column">
                            <div>{color} Color</div>
                            <h2>{prop.cars.color}</h2>
                        </div>
                    </div>
                </div>
                <div className="car-story">
                    ...
                    <div className="renting">
                        <h2>{user}Rented by</h2>
                        <div className="profile">
                            {/* there should be an image insted of heading */}
                            <h1>RP</h1>
                        </div>
                        <h3>Random Person</h3>
                    </div>
